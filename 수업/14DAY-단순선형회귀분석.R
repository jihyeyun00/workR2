...
#####완전중요! p-value 값이 0.05보다 작고 별이 많으면 이 모델을 써도 된다. 
#####반대로 그 값이 0.05보다 크면 (자연스레 별이 없을것) 이 모델을 버려라!
...
#추세선 그리기 : https://kuduz.tistory.com/1118
...
#predict r에서 제공하는 예측수행함수->plot 에 넣어서 확인
