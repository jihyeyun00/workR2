...
word_data <- readLines('외국인 방문객.txt', encoding = 'UTF-8')
word_data
...
undata2 <- gsub('전체', '', undata2)
undata2 <- gsub('비율', '', undata2)
undata2 <- gsub('<표', '', undata2)
undata2 <- gsub('완전', '', undata2)
undata2 <- gsub('응답자', '', undata2)
undata2 <- gsub('단위', '', undata2)
undata2 <- gsub('성별', '', undata2)
undata2 <- gsub('목적', '', undata2)
undata2 <- gsub('Base', '', undata2)
